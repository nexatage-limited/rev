          ...
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-6 pb-6">
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  { icon: "verified", label: "Verify Technician", color: "primary", href: "/admin/technicians" },
                  { icon: "gavel", label: "Resolve Dispute", color: "accent", href: "/admin/disputes" },
                  { icon: "local_shipping", label: "Assign Delivery", color: "slate", href: "/admin/deliveries" },
                  { icon: "person_add", label: "Invite Admin", color: "slate", href: "/admin/users" },
                ].map((action, i) => (
