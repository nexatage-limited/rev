...
export default function SignupPage() {
  ...
  const userType = params.type as string // 'user' or 'technician'
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-4 py-8 lg:px-20 relative bg-[#f8f7f5]">
        ...
        <div className="w-full max-w-sm lg:max-w-md">
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-black tracking-[-0.033em] text-[#181410] mb-2">
              {userType === 'technician' ? 'Join as Technician' : 'Get Your Device Fixed'}
            </h2>
            <p className="text-gray-500">
              {userType === 'technician' 
                ? 'Start earning with verified repair jobs' 
                : 'Connect with trusted repair experts'}
            </p>
          </div>

          {/* Tabs */}
          <div className="flex border-b border-[#e7dfda] mb-8 w-full">
            <Link href="/login" className="flex flex-1 flex-col items-center justify-center border-b-[3px] border-transparent hover:border-gray-300 pb-3 cursor-pointer group transition-colors">
              <p className="text-gray-400 text-sm font-bold leading-normal tracking-[0.015em] group-hover:text-gray-600">Log In</p>
            </Link>
            <button className="flex flex-1 flex-col items-center justify-center border-b-[3px] border-[#ff6a00] pb-3 cursor-pointer group">
              <p className="text-[#181410] text-sm font-bold leading-normal tracking-[0.015em]">Sign Up</p>
            </button>
          </div>
          ...
          <div className="mt-8 text-center space-y-4">
            ...
            {!isLogin && (
              <p className="text-sm text-gray-600">
                ...
                <Link href="/login" className="text-[#ff6a00] hover:underline font-medium">
                  Sign in here
                </Link>
              </p>
            )}
